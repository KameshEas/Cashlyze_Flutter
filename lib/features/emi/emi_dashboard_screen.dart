    ...
    return AnimatedContainer(
      ...
      child: scheduleAsync.when(
        ...
        data: (items) {
          ...
          final nextLabel = days >= 0
              ? 'in $days days'
              : 'overdue by ${days.abs()} days';
          final estCompletion = items.isNotEmpty
              ? items.last.dueDate
              : plan.startDate;
          return Column(
            ...
            children: [
              (pending > 0)
                  ? Row(
                      children: [
                        ...
                        Text(
                          'Next: ${nextDue.dueDate.toLocal()}'.split(' ').first,
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    'Rate: ${plan.annualInterestRate.toStringAsFixed(2)}%',
                    style: Theme.of(context).textTheme.bodySmall,
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text(
                    'Est. completion: ${estCompletion.toLocal()}'
                        .split(' ')
                        .first,
                    style: Theme.of(context).textTheme.bodySmall,
                  ),
